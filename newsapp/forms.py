...
class RegisterForm(UserCreationForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields['subscribed_publishers'].queryset = User.objects.filter(role='journalist')
        self.fields['subscribed_journalists'].queryset = User.objects.filter(role='journalist')
